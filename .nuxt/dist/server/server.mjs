...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "p-4 pb-10" }, _attrs))} data-v-8246982d><div class="container mx-auto flex justify-between items-center mt-4" data-v-8246982d><div class="flex space-x-6 items-start text-header" data-v-8246982d><div data-v-8246982d><p class="text-xs" data-v-8246982d> WWW.KOAFAITH.TW<br data-v-8246982d>©KOAFAITH. </p></div><div class="hidden md:block" data-v-8246982d><p class="text-xs" data-v-8246982d> WEB + GRAPHIC + CI<br data-v-8246982d>FRONT AND BACKEND PROGRAMMING </p></div></div><div class="flex items-center space-x-6" data-v-8246982d><div data-v-8246982d><audio preload="auto" loop data-v-8246982d></audio></div></div></div></header>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-8246982d"]]);
const _sfc_main$8 = {
  name: "ThreePage",
  setup() {
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "three-page" }, _attrs))} data-v-054763a5><div class="three-container" data-v-054763a5></div></div>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-054763a5"]]);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-6f700a75><div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex space-x-4" data-v-6f700a75><!--[-->`);
  ssrRenderList($setup.directions, (direction, index) => {
    _push(`<div class="${ssrRenderClass(["w-16 h-16 flex items-center justify-center text-2xl", { "bg-yellow-500": $setup.activeKey === direction, "bg-gray-700 text-white": $setup.activeKey !== direction }])}" data-v-6f700a75>${ssrInterpolate(direction)}</div>`);
  });
  _push(`<!--]--></div><div class="absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-black to-gray-500" data-v-6f700a75></div><div class="absolute top-4 left-1/2 transform -translate-x-1/2 text-black text-3xl" data-v-6f700a75>Score: ${ssrInterpolate($setup.score)}</div>`);
  if ($setup.gameOver) {
    _push(`<div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-75 text-white text-4xl" data-v-6f700a75> Game Over <button class="ml-4 px-4 py-2 bg-white text-black rounded" data-v-6f700a75>Restart</button></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const Service = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-6f700a75"]]);
const _sfc_main$4 = {
  name: "Contact",
  data() {
    return {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto p-4 text-contact" }, _attrs))} data-v-ab5b87d5><div class="p-6 text-center" data-v-ab5b87d5><p class="mb-6 text-lg font-medium text-gray-700 max-w-2xl mx-auto" data-v-ab5b87d5> 我們致力於提供最佳解決方案，以滿足您的業務需求。無論是技術諮詢、專案合作，還是產品與服務的詳細資訊，我們的團隊隨時為您提供專業且客製化的支援。請隨時與我們聯繫，以獲取更多資訊並開啟雙方合作的契機。 </p><div class="contact-info p-6" data-v-ab5b87d5><div class="contact-item flex justify-center items-center" data-v-ab5b87d5><div class="w-full max-w-xl" data-v-ab5b87d5><form action="https://formspree.io/f/xqakbagv" method="POST" class="p-6 rounded-lg" data-v-ab5b87d5><div class="mb-4 flex items-center" data-v-ab5b87d5><label for="email" class="block text-lg font-medium text-gray-700 w-1/3 text-left" data-v-ab5b87d5>您的電子郵件</label><input type="email" id="email" name="email" class="p-2 w-2/3 border border-gray-300 rounded-md bg-opacity-50" required data-v-ab5b87d5></div><div class="mb-4 flex items-center" data-v-ab5b87d5><label for="message" class="block text-lg font-medium text-gray-700 w-1/3 text-left" data-v-ab5b87d5>留言訊息</label><textarea id="message" name="message" rows="4" class="p-2 w-2/3 border border-gray-300 rounded-md bg-opacity-50" required data-v-ab5b87d5></textarea></div><button type="submit" class="mt-5 px-6 py-2 border-2 border-gray-500 text-gray-500 text-lg font-bold rounded hover:bg-orange-500 hover:text-white min-w-60" data-v-ab5b87d5>送出</button></form></div></div></div></div></div>`);
}
...
const Contact = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-ab5b87d5"]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))} data-v-4e3c5c13><div class="${ssrRenderClass([$setup.divClass, "flex transition-all duration-500 ease-in-out"])}" data-v-4e3c5c13><div class="absolute top-40 left-1/2 transform -translate-x-1/2 -translate-y-1/2" data-v-4e3c5c13><img${ssrRenderAttr("src", _imports_0)} alt="logo" class="h-auto w-[450px] md:w-[400px] lg:w-[350px] xl:w-[300px]" data-v-4e3c5c13></div></div><div class="w-full flex justify-center mt-10" data-v-4e3c5c13><ul class="flex space-x-12 items-center font" data-v-4e3c5c13><li data-v-4e3c5c13><a href="#" class="${ssrRenderClass([{ "text-gray-900 scale-125 underline": $setup.currentPage === "About" }, "block text-gray-700 hover:text-gray-900 hover:scale-125 hover:underline transition-transform duration-300"])}" data-v-4e3c5c13>ABOUT</a></li><li data-v-4e3c5c13><a href="#" class="${ssrRenderClass([{ "text-gray-900 scale-125 underline": $setup.currentPage === "Project" }, "block text-gray-700 hover:text-gray-900 hover:scale-125 hover:underline transition-transform duration-300"])}" data-v-4e3c5c13>PROJECT</a></li><li data-v-4e3c5c13><a href="#" class="${ssrRenderClass([{ "text-gray-900 scale-125 underline": $setup.currentPage === "Contact" }, "block text-gray-700 hover:text-gray-900 hover:scale-125 hover:underline transition-transform duration-300"])}" data-v-4e3c5c13>CONTACT</a></li></ul></div>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-4e3c5c13"]]);
